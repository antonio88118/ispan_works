...
<body>
    <div class="container">
        ...
        <div class="pb-2 d-flex justify-content-end">
            <div class="btn-group">
                <a class="btn btn-primary <?php if($order==1) echo "active"?>" href="user-list.php?page=<?=$page?>&order=1">id <i class="bi bi-sort-down-alt"></i></a>
                <a class="btn btn-primary <?php if($order==2) echo "active"?>" href="user-list.php?page=<?=$page?>&order=2">id <i class="bi bi-sort-down"></i></a>
                <a class="btn btn-primary <?php if($order==3) echo "active"?>" href="user-list.php?page=<?=$page?>&order=3">name <i class="bi bi-sort-down-alt"></i></a>
